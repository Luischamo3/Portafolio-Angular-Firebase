...
@NgModule({
  /*Con el usehash las páginas sabrán que lo que viene después de las rutas no es una directorio si no que es una parte de la ruta si para estos servidores en los cuales no tenemos acceso al archivo htaccess */
